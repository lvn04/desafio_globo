...
planets = StructType([
    ...
    StructField("name", StringType(), True),
    StructField("orbital_period", IntegerType(), True),
    StructField("population", IntegerType(), True),
    StructField("residents", ArrayType(StringType()), True),
    StructField("rotation_period", IntegerType(), True),
    StructField("surface_water", IntegerType(), True), 
...
species = StructType([
    StructField("average_height", IntegerType(), True),
...
vehicles = StructType([
    StructField("cargo_capacity", IntegerType(), True),
    StructField("consumables", StringType(), True),
    StructField("cost_in_credits", IntegerType(), True),
    StructField("created", TimestampType(), True),
    StructField("crew", IntegerType(), True),
    StructField("edited", TimestampType(), True),
    StructField("films", ArrayType(StringType()), True),
    StructField("length", DoubleType(), True),
    StructField("manufacturer", StringType(), True),
    StructField("max_atmosphering_speed", IntegerType(), True),
...
starships =  StructType([
    ...
    StructField("edited", TimestampType(), True),
    StructField("films", ArrayType(StringType()), True),
    StructField("hyperdrive_rating", DoubleType(), True),
